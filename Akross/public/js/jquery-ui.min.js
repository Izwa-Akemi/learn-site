...
!function (t) {
  ...
  x.cleanData = (n = x.cleanData, function (t) {
    ...
    for (var e, i, s = r.call(arguments, 1), n = 0, a = s.length; n < a; n++) {
      for (e in s[n]) {
        i = s[n][e], s[n].hasOwnProperty(e) && void 0 !== i && (x.isPlainObject(i) ? t[e] = x.isPlainObject(t[e]) ? x.widget.extend({}, t[e], i) : x.widget.extend({}, i) : t[e] = i);
      }
    }
    ...
    option: function option(t, e) {
      ...
      if ("string" == typeof t) if (a = {}, t = (i = t.split(".")).shift(), i.length) {
        for (s = a[t] = x.widget.extend({}, this.options[t]), n = 0; n < i.length - 1; n++) {
          s[i[n]] = s[i[n]] || {}, s = s[i[n]];
        }
    ...
    _setOptionClasses: function _setOptionClasses(t) {
      ...
      for (e in t) {
        s = this.classesElementLookup[e], t[e] !== this.options.classes[e] && s && s.length && (i = x(s.get()), this._removeClass(s, e), i.addClass(this._classes({
          element: i,
          keys: e,
          classes: t,
          add: !0
    ...
    _classes: function _classes(n) {
      ...
      function t(t, e) {
        for (var i, s = 0; s < t.length; s++) {
          i = o.classesElementLookup[t[s]] || x(), i = n.add ? x(x.unique(i.get().concat(n.element.get()))) : x(i.not(n.element).get()), o.classesElementLookup[t[s]] = i, a.push(t[s]), e && n.classes[t[s]] && a.push(n.classes[t[s]]);
        }
      }
    ...
    _trigger: function _trigger(t, e, i) {
      var s,
          n,
          a = this.options[t];
      if (i = i || {}, (e = x.Event(e)).type = (t === this.widgetEventPrefix ? t : this.widgetEventPrefix + t).toLowerCase(), e.target = this.element[0], n = e.originalEvent) for (s in n) {
        s in e || (e[s] = n[s]);
      }
  ...
  C = Math.max, T = Math.abs, a = /left|center|right/, o = /top|center|bottom/, l = /[\+\-]\d+(\.[\d]+)?%?/, h = /^\w+/, c = /%$/, W = x.fn.position, x.position = {
    ...
    if (!u || !u.of) return W.apply(this, arguments);
    u = x.extend({}, u);
    ...
    var d,
        ...
        t,
        v = x(u.of),
        m = x.position.getWithinInfo(u.within),
        _ = x.position.getScrollInfo(m),
    ...
    return v[0].preventDefault && (u.at = "left top"), f = e.width, p = e.height, g = e.offset, b = x.extend({}, g), x.each(["my", "at"], function () {
      var t,
          e,
          i = (u[this] || "").split(" ");
    ...
    }), 1 === y.length && (y[1] = y[0]), "right" === u.at[0] ? b.left += f : "center" === u.at[0] && (b.left += f / 2), "bottom" === u.at[1] ? b.top += p : "center" === u.at[1] && (b.top += p / 2), d = E(w.at, f, p), b.left += d[0], b.top += d[1], this.each(function () {
      var i,
          t,
          o = x(this),
          r = o.outerWidth(),
          ...
          e = P(this, "marginLeft"),
          s = P(this, "marginTop"),
          n = r + e + P(this, "marginRight") + _.width,
          a = l + s + P(this, "marginBottom") + _.height,
          h = x.extend({}, b),
          c = E(w.my, o.outerWidth(), o.outerHeight());
      ...
      "right" === u.my[0] ? h.left -= r : "center" === u.my[0] && (h.left -= r / 2), "bottom" === u.my[1] ? h.top -= l : "center" === u.my[1] && (h.top -= l / 2), h.left += c[0], h.top += c[1], i = {
        ...
        f < r && T(e + i) < f && (a.horizontal = "center"), p < l && T(s + n) < p && (a.vertical = "middle"), C(T(e), T(i)) > C(T(s), T(n)) ? a.important = "horizontal" : a.important = "vertical", u.using.call(this, _t, a);
      }), o.offset(x.extend(h, {
        using: t
      }));
    });
    ...
    flip: {
      left: function left(t, e) {
        var i = e.within,
            ...
            o = -2 * e.offset[0];
        r < 0 ? ((s = t.left + h + i + o + e.collisionWidth - n - s) < 0 || s < T(r)) && (t.left += h + i + o) : 0 < l && (0 < (a = t.left - e.collisionPosition.marginLeft + h + i + o - a) || T(a) < l) && (t.left += h + i + o);
      },
      top: function top(t, e) {
        var i = e.within,
            ...
            o = -2 * e.offset[1];
        r < 0 ? ((s = t.top + h + i + o + e.collisionHeight - n - s) < 0 || s < T(r)) && (t.top += h + i + o) : 0 < l && (0 < (a = t.top - e.collisionPosition.marginTop + h + i + o - a) || T(a) < l) && (t.top += h + i + o);
      }
    },
    flipfit: {
      left: function left() {
  ...
  x.ui.focusable = function (t, e) {
    ...
    return "area" === o ? (s = (i = t.parentNode).name, !(!t.href || !s || "map" !== i.nodeName.toLowerCase()) && 0 < (s = x("img[usemap='#" + s + "']")).length && s.is(":visible")) : (/^(input|select|textarea|button|object)$/.test(o) ? (n = !t.disabled) && (a = x(t).closest("fieldset")[0]) && (n = !a.disabled) : n = "a" === o && t.href || e, n && x(t).is(":visible") && function (t) {
  ...
  x.widget("ui.tabs", {
    ...
    _isLocal: (d = /#.*$/, function (t) {
      var e = t.href.replace(d, ""),
          i = location.href.replace(d, "");
    ...
    _findNextTab: function _findNextTab(t, e) {
      ...
      for (; -1 !== x.inArray((i < t && (t = 0), t < 0 && (t = i), t), this.options.disabled);) {
        t = e ? t + 1 : t - 1;
      }
    ...
    _setOptionDisabled: function _setOptionDisabled(t) {
      ...
      for (x.isArray(t) && (t.length ? t.length === this.anchors.length && (t = !0) : t = !1), i = 0; e = this.tabs[i]; i++) {
        e = x(e), !0 === t || -1 !== x.inArray(i, t) ? (e.attr("aria-disabled", "true"), this._addClass(e, null, "ui-state-disabled")) : (e.removeAttr("aria-disabled"), this._removeClass(e, null, "ui-state-disabled"));
      }
